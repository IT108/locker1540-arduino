...
void webServer() {
    ...
    if (req.indexOf(pass + addCardReq) != -1) {
        if (req.indexOf(nameSymbol) != -1) {
            freq = req.substring(req.indexOf(pass + addCardReq) + pass.length() + addCardReq.length(),
                                 req.indexOf(pass + addCardReq) + pass.length() + addCardReq.length() + 8);
        ...
        freq = req.substring(req.indexOf(pass + removeCardReq) + pass.length() + removeCardReq.length(),
                             req.indexOf(pass + removeCardReq) + pass.length() + removeCardReq.length() + 8);
        ...
        if (debug) DebugSerial.println("invalid request");
